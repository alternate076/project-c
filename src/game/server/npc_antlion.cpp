...
// base antlion stuff
ConVar	sk_antlion_health("sk_antlion_health", "100");
ConVar	sk_antlion_swipe_damage("sk_antlion_swipe_damage", "10");
ConVar	sk_antlion_jump_damage("sk_antlion_jump_damage", "20");
ConVar  sk_antlion_air_attack_dmg("sk_antlion_air_attack_dmg", "5");
