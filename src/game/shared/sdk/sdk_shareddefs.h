...
#define SDK_GAME_DESCRIPTION	"Project-C Multiplayer"
...
#define SDK_DEFAULT_PLAYER_SPRINTSPEED		350
...
#define SDK_PLAYER_DEATH_TIME	10.0f	//Minimum Time before respawning
