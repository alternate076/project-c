...
BEGIN_VS_SHADER( PP_LightmappedGeneric,
	...
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM( DETAILBLENDMODE, SHADER_PARAM_TYPE_INTEGER, "3", "mode for combining detail texture with base. 0=normal, 1= additive, 2=alpha blend detail over base, 3=crossfade" )
		...
		SHADER_PARAM( NODIFFUSEBUMPLIGHTING, SHADER_PARAM_TYPE_INTEGER, "1", "0 == Use diffuse bump lighting, 1 = No diffuse bump lighting" )
		...
		SHADER_PARAM( PHONGEXPONENT, SHADER_PARAM_TYPE_FLOAT, "2.0", "Phong exponent for local specular lights" )
END_SHADER_PARAMS
