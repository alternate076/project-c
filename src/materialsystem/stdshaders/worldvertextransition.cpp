...
BEGIN_VS_SHADER( PP_WorldVertexTransition_DX9, "Help for WorldVertexTransition" )
	...
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM( BUMPFRAME2, SHADER_PARAM_TYPE_INTEGER, "1", "frame number for $bumpmap" )
		...
		SHADER_PARAM( FRAME2, SHADER_PARAM_TYPE_INTEGER, "1", "frame number for $basetexture2" )
