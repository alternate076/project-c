...
BEGIN_VS_SHADER( PP_VertexLitGeneric, "Help for VertexLitGeneric" )
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM( PHONGEXPONENT, SHADER_PARAM_TYPE_FLOAT, "0.5", "Phong exponent for local specular lights" )
		SHADER_PARAM( PHONGTINT, SHADER_PARAM_TYPE_VEC3, "2.0", "Phong tint for local specular lights" )
		...
		SHADER_PARAM( PHONGBOOST, SHADER_PARAM_TYPE_FLOAT, "0.1", "Phong overbrightening factor (specular mask channel should be authored to account for this)" )
		...
		SHADER_PARAM( PHONG, SHADER_PARAM_TYPE_BOOL, "1", "enables phong lighting" )
		...
		SHADER_PARAM( ENVMAPFRESNEL, SHADER_PARAM_TYPE_FLOAT, "1", "Degree to which Fresnel should be applied to env map" )
		...
		SHADER_PARAM( SELFILLUMMASKFRAME, SHADER_PARAM_TYPE_INTEGER, "1", "" )
		...
		SHADER_PARAM( RIMLIGHTBOOST, SHADER_PARAM_TYPE_FLOAT, "0.5", "Boost for rim lights" )
